package com.alan.cake.backup.constants;
...
public interface BackupConstants {
	...
	/** 备份目录名称 */
	public static final String BACKUP_FOLDER_NAME = "_cake_backup";
	/** 备份目录 */
	public static final String BACKUP_FOLDER = System.getProperty("user.home") + File.separator + "eclipse-workspace" + File.separator + BACKUP_FOLDER_NAME + File.separator;
	/** 还原目录，默认就是备份目录 */
	...
	/** 默认备份文件名 */
	public static final String BACKUP_FILE_NAME = "cake" + SQL_EXT;
	/** 默认备份还原目录名称 */
