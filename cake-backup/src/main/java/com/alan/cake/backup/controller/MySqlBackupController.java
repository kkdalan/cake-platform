package com.alan.cake.backup.controller;
...
import com.alan.cake.backup.config.BackupDataSourceProperties;
import com.alan.cake.backup.constants.BackupConstants;
import com.alan.cake.backup.service.MysqlBackupService;
import com.alan.cake.common.utils.FileUtils;
import com.alan.cake.core.http.HttpResult;
import com.alan.cake.core.http.HttpStatus;
...
public class MySqlBackupController {
	...
	private HttpResult backup(String backupFodlerName) {
		...
		try {
			...
			return HttpResult.error(HttpStatus.SC_INTERNAL_SERVER_ERROR, e.getMessage());
		}
