package com.alan.cake.backup.util;
...
public class MySqlBackupRestoreUtils {
	...
	private static final String MYSQL_HOME = "/usr/local/mysql/bin/";
	...
	public static boolean backup(String host, String userName, String password, String backupFolderPath, String fileName,
		...
		if (process.waitFor() == 0) {
			...
			System.out.println("執行指令發生錯誤，錯誤碼：" + process.waitFor());
		}
		return false;
	}
	...
	private static String[] getCommand(String command) {
		...
		String c = "-c";
		String cmdstr = MYSQL_HOME + command;
		if(os.toLowerCase().startsWith("win")){  
			shell = "cmd";
			c = "/c";
			cmdstr = command;
		}
		String[] cmd = { shell, c, cmdstr };
		return cmd;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		String backupFolderPath = "/Users/alan/eclipse-workspace/backup/dev/";
		String fileName = "cake.sql";
		MySqlBackupRestoreUtils.backup(host, userName, password, backupFolderPath, fileName, database);
		System.out.println("备份成功");
		
		System.out.println("开始还原");
		String restoreFilePath = "/Users/alan/eclipse-workspace/backup/dev/cake.sql";
